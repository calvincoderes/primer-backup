...
export const exists = (object, falseValue = null, trueValue = null) =>
  typeof object !== 'undefined' && object ? (trueValue !== null ? trueValue : object) : falseValue
...
export const FormItem = ({
  ...
  return (
    ...
    >
      ...
      {!validateStatus && specialInstruction && (
        <span style={{ fontSize: '10px', color: '#00263D' }}>{specialInstruction}</span>
      )}
    </Form.Item>
  )
}
...
export const FormReadOnlyItem = ({ value, text = '', required = false }) => (
  <div style={{ marginBottom: 8 }}>
    ...
    <div className="ro-value-div">{value || '-'}</div>
  </div>
)

FormReadOnlyItem.defaultProps = {
  text: '',
  required: false,
}
